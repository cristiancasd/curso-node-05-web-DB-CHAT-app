...
const dibujarMensajesPriv=({usuario,mensaje})=>{
    ...
    let mensajesHtml=`<p>Privado ${usuario.nombre} id:${usuario.uid} </p>`;
                ...
                window.open("privado.html?"+usuario.uid)
                //window.open=(('privado.html?='+usuario.uid),'_blank') ;
